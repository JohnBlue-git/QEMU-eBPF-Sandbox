...
int main(int argc, char* argv[])
{
    ...
    std::vector<std::string> object_candidates = {
        "/opt/ebpf_boost_asio_design/socket_filter.bpf.o",
        "./socket_filter.bpf.o",
        "build/socket_filter.bpf.o",
    };

    std::vector<std::string> log_candidates = {
        "/var/log/ebpf_boost_asio_design/socket_filter.events.log",
    ...
    std::string log_path_full = "/var/log/ebpf_boost_asio_design/socket_filter.events.log";
